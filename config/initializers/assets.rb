...
Rails.application.config.assets.precompile += %w( ember-accounts.js ember-accounts.css vendor-accounts.js  flex_layout.css marketing.js marketing/main.css vendor/jquery.js bootstrap.css bootstrap.js board/application.js jquery-ui.superSortable.js vendor/jquery-ui.js )
